...
export type NormalizedSaveRequestPayload = {
...
export function findDuplicateVariantSku(variants: NormalizedVariantInput[]): string | null {
...
export function normalizeInventorySavePayload(body: SaveRequestPayload): NormalizedSaveRequestPayload {
...
export function validateInventorySavePayload(
  payload: NormalizedSaveRequestPayload
