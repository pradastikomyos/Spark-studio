-- ============================================================================
-- FASHION LOOKBOOK MIGRATION
-- ============================================================================
-- Purpose: Add fashion lookbook tables for interactive runway-style showcase
-- Date: 2026-02-28
-- Tables: fashion_collections, fashion_looks, fashion_look_items
-- Storage: fashion-images bucket for model cutout PNGs
-- ============================================================================

-- ============================================================================
-- TABLE: fashion_collections
-- ============================================================================
...
CREATE INDEX idx_fashion_collections_active ON public.fashion_collections(is_active, sort_order);
CREATE INDEX idx_fashion_collections_slug ON public.fashion_collections(slug);
...
CREATE INDEX idx_fashion_looks_collection ON public.fashion_looks(collection_id, sort_order);
...
CREATE INDEX idx_fashion_look_items_look ON public.fashion_look_items(look_id, sort_order);
...
BEGIN
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Fashion Lookbook Migration COMPLETED';
  RAISE NOTICE 'Tables: fashion_collections, fashion_looks, fashion_look_items';
  RAISE NOTICE 'Storage: fashion-images bucket';
  RAISE NOTICE 'RLS: Public read (active only), admin write';
  RAISE NOTICE '========================================';
END $$;
