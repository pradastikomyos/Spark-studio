...
export default function CheckoutPage() {
  ...
  // Redirect to proper product checkout page
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="flex-1 flex flex-col w-full lg:w-[58%] border-r border-gray-100 bg-white order-2 lg:order-1">
        ...
        <header className="px-6 py-6 lg:px-12 xl:px-20 border-b border-gray-50 lg:border-none">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-[#1c0d0d] text-xl font-bold tracking-tight">Spark Stage</h2>
          </div>
        </header>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border-border-light bg-rose-50 px-4 py-3 text-base focus:border-primary focus:ring-primary/20 placeholder:text-gray-400 font-body transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-body">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-lg border-border-light bg-rose-50 px-4 py-3 text-base focus:border-primary focus:ring-primary/20"
                    required
                  />
                </div>
                <div>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-6">
                ...
                <div className="border border-border-light rounded-lg overflow-hidden bg-white">
                  <div className="px-5 py-4 bg-rose-50 border-b border-border-light">
                    ...
                    {paymentMethods.virtualAccount.map((method, index) => (
                      ...
                      >
                        ...
                        <div className={`p-4 flex items-center justify-between transition-colors ${
                          paymentMethod === method.id ? 'bg-rose-50' : 'hover:bg-rose-50'
                        }`}>
      ...
      <div className="w-full lg:w-[42%] bg-background-light border-l border-gray-200 order-1 lg:order-2">
        <div className="lg:sticky lg:top-0 h-auto lg:h-screen lg:overflow-y-auto px-6 py-8 lg:px-10 lg:py-12 flex flex-col">
          ...
          <button
            ...
            className="w-full bg-[#D32F2F] hover:bg-[#B71C1C] text-white rounded-lg py-4 px-6 font-bold text-lg shadow-lg hover:shadow-xl transition-all transform active:scale-[0.99] flex items-center justify-center gap-2 group"
          >
