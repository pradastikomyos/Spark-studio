  ...
  return (
    <div className="min-h-screen bg-background-light">
      <main className="flex-grow max-w-7xl mx-auto px-6 lg:px-12 py-16 w-full">
        <header className="mb-16 border-b border-gray-200 pb-8 flex flex-col md:flex-row justify-between items-start md:items-end">
          <div>
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-light mb-4">Your Selection</h1>
            <p className="text-gray-500 font-light tracking-wide text-sm uppercase">{items.length} Items in Cart</p>
          </div>
          <button
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-2/3 space-y-12">
            {items.length === 0 ? (
              <div className="text-center py-16">
                <span className="material-icons-outlined text-6xl text-gray-300 mb-4">shopping_cart</span>
              ...
              items.map((item) => (
                <div
                  key={item.variantId}
                  className="group flex flex-col sm:flex-row gap-8 pb-12 border-b border-gray-200 transition-all duration-300 hover:border-gray-400:border-gray-600"
                >
                  <div className="relative w-full sm:w-48 aspect-[3/4] overflow-hidden bg-gray-100">
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-gray-500 text-sm tracking-wide mb-6">{item.variantName}</p>
                    </div>
                    ...
                    <div className="flex justify-between items-end">
                      <div className="flex items-center border border-gray-300">
                        <button
                          ...
                          className="px-3 py-1 hover:bg-gray-200:bg-gray-700 transition-colors text-gray-500"
                        >
                          -
                        </button>
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-28 bg-surface-light p-8 border border-gray-200 shadow-xl">
              ...
              <div className="space-y-4 text-sm font-light mb-8">
                ...
                <div className="border-t border-gray-300 pt-4 flex justify-between font-normal">
                  <span>Total</span>
