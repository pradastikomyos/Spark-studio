      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-sm hover:bg-gray-50:bg-white transition-colors">
            ...
            <button className="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-sm hover:bg-gray-50:bg-white transition-colors">
              ...
              <span className="text-sm font-medium text-text-light">{t('auth.login.providers.github')}</span>
            </button>
          </div>
