...
export function ProductImageCarousel(props: ProductImageCarouselProps) {
  ...
  if (!hasImages) {
    return (
      <div
        className={[
          'rounded-2xl overflow-hidden bg-gray-100 dark:bg-surface-dark border border-gray-200 dark:border-gray-800',
          className,
        ]
          .filter(Boolean)
          .join(' ')}
  ...
  return (
    <div
      className={[
        'relative rounded-2xl overflow-hidden bg-gray-100 dark:bg-surface-dark border border-gray-200 dark:border-gray-800',
        className,
      ]
        .filter(Boolean)
        .join(' ')}
